...
<div>
  <div className="author">
    ...
    <div className="profile">
      ...
      <p className="about">
        Вікторія працює в Binary Studio як Full stack developer після закінчення
        Binary Studio Academy в 2020.
      </p>
    </div>
  </div>
  <div className="bubble" style={{ margin: "-0.5em 1em 1em"}}>
    <strong>Привіт!</strong> 👋 <br />
    Тут ти знайдеш детальну інструкцію до домашки по Git - тож тобі потрібно лиш
    виконувати інструкції і готово ✅. Але спочатку, зверни увагу, що:
    <ol className="compact inverted">
      ...
      <li>
        будь ласка, <strong>не пропускайте</strong> жодних кроків
        і нічого не перейменовуйте - ми запустимо автоматичні тести після того,
        як ви заллєте домашнє завдання на перевірку і назви репозиторію, гілок,
        та завдань можуть бути важливі!
      </li>
...
<div id="table-of-contents" className="table-of-contents" style={{ marginTop: 2 + "em"}}>
  <h2>
    <strong>Створи та захости власне резюме використовуючи GitHub</strong>
  </h2>
  <TimelineOfContents
    timeline={[
      {
