---
orderId: 3
author: "Володимир Лєнч"
title: "Modern PHP features and ecosystem"
description: "Володимир проводить екскурс у фундаментальні поняття та новинки <strong>PHP</strong>,пояснює у яких випадках використовуються найбільш поширені фреймворки, показує як працювати з <strong>Composer</strong> та розказує про типое оточення PHP-програміста."
keywords: ["hola", "guapa"]
duration: "35 хв"
...
import { default as meme } from './assets/images/meme-ua.jpg';
...
<VideoWrapper duration="35 хв 41 сек">
...
<div>
  <div className="author">
    ...
    <div className="profile">
      <h3 className="name">Володимир Лєнч</h3>
  ...
  <div className="bubble" style={{ margin: "-0.5em 1em 1em"}}>
    ...
    <ol className="compact inverted">
      <li>частина матеріалу вам вже знайома і це гуд 😊;</li>
      <li>лекція обіцяє бути цікавою та познавальною <em>(за використання слів-паразитів, жаргону та нецензурної лайки вибачайте)</em>.</li>
    </ol>
...
<div className="bubble small subtle">
  <strong>PHP</strong> <em>(ПХП, похапэ, пэхэпэ, пиашпи, пих-пих, ПиЭйчПи)</em> — одна з небагатьох мов програмуання, володіючи якою, можна заробити собі на хліб, $ало та воду.
</div>
...
<div className="bubble">
  А на сьогодні все! Свої питання та відгуки залишайте на сайті <a href="https://academy.binary-studio.com/"><strong>Binary Studio Academy</strong></a>. Бажаю вам успіхів, не втрачайте мотивації та вчіться з задоволенням. Дякую за увагу! 🤙
</div>
