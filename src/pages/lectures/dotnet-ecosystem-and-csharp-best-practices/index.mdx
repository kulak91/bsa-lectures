...
<div>
  <div className="author">
    ...
    <div className="profile">
      ...
      <p className="about">Іван працює Full Stack веб-розробником у <a href="https://binary-studio.com"><strong>Binary Studio</strong></a>. Пише на C# і TypeScript. З хобі ― слухати музику, грати в аркади, займатися йогою. Вирішив вперше записати лекцію для Академії, щоб тобі було легше розібратися з екосистемою .NET.</p>
    </div>
  </div>
...
<p style={{ marginLeft: 0.25 + "em"}}>Зараз компанія Microsoft вкладає досить багато ресурсів у розвиток .NET та їхньої хмарної платформи — Azure <em>(Ажур, Ежур, Ейжа)</em> та найбільше контрибьютить в open source. Інфраструктура .NET стрімко росте та розвивається, постійно створюютсья нові інструменти для роботи з нею, додаються інтеграції з іншими сервісами.</p>

<ul>
  <li className="details">
    <input type="checkbox" id="accordion-1-1" />
    <label className="summary" for="accordion-1-1">
      <h5>
  ...
  <li className="details">
    ...
    <label className="summary" for="accordion-1-2">
      <h5>
        Платформа <strong>.NET 6</strong>
      </h5>
    </label>
    <div className="details-body details-body-with-image" style={{ marginBottom: 0.5 + "em"}}>
      <img src={dotnet6Platform} alt="dotnet5-platform" className="top-image"/>
       <p>З листопада 2021 року випущено <strong>.NET 6</strong>. Що стало серйозним вдосконаленням системи розробки в цілому.
...
<ul>
  <li className="details">
    ...
    <label className="summary" for="accordion-2-1">
      <h5 style={{ display: 'flex', alignItems: 'center'}}>
        <span style={{ marginRight: 0.25 + "em"}}><strong>CLR</strong></span>
    ...
    <div className="details-body" style={{ marginBottom: 0.5 + "em"}}>
      ...
      <ul>
        <li className="details">
          ...
          <label className="summary" for="accordion-2-1-1">
  ...
  <li className="details">
    ...
    <label className="summary" for="accordion-2-2">
  ...
  <li className="details">
    ...
    <label className="summary" for="accordion-2-3">
  ...
  <li className="details">
    ...
    <label className="summary" for="accordion-2-4">
  ...
  <li className="details">
    ...
    <label className="summary" for="accordion-2-5">
  ...
  <li className="details">
    ...
    <div className="details-body" style={{ marginBottom: 0.5 + "em"}}>
      ...
      <p>
        ...
        <strong>
          створити функціонал, який реалізується у похідному від нього
          класі
        </strong>
    ...
    <div className="details-body" style={{ marginBottom: 0.5 + "em"}}>
      ...
      <ul>
        <li className="details">
          ...
          <label
            className="summary"
            htmlFor="accordion-3-IDisposable-example"
          >
    ...
    <div className="details-body" style={{ marginBottom: 0.5 + "em"}}>
      ...
      <ul>
        <li className="details">
          ...
          <label
            className="summary"
            htmlFor="accordion-3-Generic-example"
          >
        ...
        <li className="details">
          ...
          <label
            className="summary"
            htmlFor="accordion-3-Generic-example-2"
          >
        ...
        <li className="details">
          ...
          <label
            className="summary"
            htmlFor="accordion-3-Generic-сonstraints"
          >
        ...
        <li className="details">
          <input
            type="checkbox"
            id="accordion-3-Generic-all-сonstraints"
          />
          <label
            className="summary"
            htmlFor="accordion-3-Generic-all-сonstraints"
          >
        ...
        <li className="details">
          ...
          <div className="details-body" style={{ marginBottom: 0.5 + "em"}}>
            ...
            <p>
              ...
              <a href="https://github.com/binary-studio-academy/stage-2-dotnet-ecosystem-and-csharp-best-practices">
                <strong>тут</strong>
              </a>
              .
            </p>
    ...
    <div className="details-body" style={{ marginBottom: 0.5 + "em"}}>
      ...
      <ul>
        <li className="details">
          ...
          <label
            className="summary"
            htmlFor="accordion-3-Collections-Hierarchy"
          >
    ...
    <div className="details-body" style={{ marginBottom: 0.5 + "em"}}>
      ...
      <ul>
        <li className="details">
          ...
          <label
            className="summary"
            htmlFor="accordion-3-try-catch-finally"
          >
        ...
        <li className="details">
          ...
          <label
            className="summary"
            htmlFor="accordion-3-Exceptions-Hierarchy"
          >
            <code>Exceptions</code> Hierarchy
          </label>
          <div
            className="details-body details-body-with-image"
        ...
        <li className="details">
          ...
          <label
            className="summary"
            htmlFor="accordion-3-Application-Exception"
          >
        ...
        <li className="details">
          ...
          <label
            className="summary"
            htmlFor="accordion-3-Exception-properties"
          >
      ...
      <p>
        Приклад обробки виняткових ситуацій ви зможете знайти{' '}
        <a href="https://github.com/binary-studio-academy/stage-2-dotnet-ecosystem-and-csharp-best-practices">
          <strong>тут</strong>
        </a>
        .
...
<ul>
  <li className="details">
    ...
    <label className="summary" for="accordion-4-1">
  ...
  <li className="details">
    ...
    <label className="summary" for="accordion-4-2">
      <h5 style={{ display: 'flex', alignItems: 'center'}}>
  ...
  <li className="details">
    ...
    <label className="summary" for="accordion-4-3">
      <h5 style={{ display: 'flex', alignItems: 'center'}}>
  ...
  <li className="details">
    ...
    <label className="summary" for="accordion-4-4">
      <h5 style={{ display: 'flex', alignItems: 'center'}}>
    ...
    <div className="details-body" style={{ marginBottom: 0.5 + "em"}}>
      ...
      <ul>
        <li className="details">
          ...
          <label className="summary" for="accordion-4-4-1">
        ...
        <li className="details">
          ...
          <label className="summary" for="accordion-4-4-2">
        ...
        <li className="details">
          ...
          <label className="summary" for="accordion-4-4-3">
        ...
        <li className="details">
          ...
          <label className="summary" for="accordion-4-4-4">
        ...
        <li className="details">
          ...
          <label className="summary" for="accordion-4-4-5">
