...
<ul>
      ...
      <ul>
        ...
        <li className="details">
          ...
          <div className="details-body" style={{ marginBottom: 0.5 + "em"}}>
            ...
            <p>
              Приклад використання подій та делегатів ви зможете знайти завантажив <DownloadZipButton title="цей файл"  fileName="dotnet-ecosystem-and-csharp-best-practices" />.
            </p>
          </div>
        </li>
      </ul>
  ...
  <li className="details">
    ...
    <div className="details-body" style={{ marginBottom: 0.5 + "em"}}>
      ...
      <p>
        Приклад обробки виняткових ситуацій ви зможете знайти завантажив <DownloadZipButton title="цей файл"  fileName="dotnet-ecosystem-and-csharp-best-practices" />.
      </p>
    </div>
  </li>
</ul>
