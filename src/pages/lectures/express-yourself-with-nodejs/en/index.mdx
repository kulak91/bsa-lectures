    ...
    <ol>
      ...
      <li>
        <DetailsCard isReversed >
          <>
            <em>server returned the file</em> / <strong>via HTTP responded with the 200 status and an HTML file</strong>
          </>
          <>
...
<div className="bubble small subtle">
  ...
  [Zip file with the code from this block](/assets/zip/nodejs-3-en.zip)
...
<DetailsCard>
  ...
  <ol className="default-list">
    <li>
      delete the folder _/public_ with all the contents
    </li>
    <li>
      make changes to _/routes/index.js_

      <SnippetJS06 />
    </li>
    <li>
      make changes to _app.js_
...
<DetailsCard>
  ...
  <ol>
    <li> Create a folder _/services_</li>

    <li> Create a file _/services/user.service.js_ </li>

    <li>
      Add a function to the file and export it:

      <SnippetJS08 />
    </li>

    <li>
      Import the function from the service to the router, use it to get a user's name.

      <SnippetJS09 />
    </li>
    <li> Run the server `npm start` </li>
    <li>
      Send POST-request to the _/users_ route and take a look at the response that contains the sent name
...
<DetailsCard>
  ...
  <ol className="default-list">
    <li> Create folder _/repositories_</li>

    <li> Create file _/repositories/user.repository.js_ </li>
    ...
    <li>
      Import the function from the repository into the service and add the function `saveName ()`:

      <SnippetJS11 />
    </li>
    <li>
      Import the function from the service into the router and use it to work with the request body:
    ...
    <li>
      Send POST-request to the _/users_ route and take a look at the response "Data is saved"
...
<DetailsCard>
  ...
  <ol className="default-list">
    <li>Create folder _/middlewares_ </li>

    <li> Create file _/middlewares/auth.middleware.js_ </li>
    ...
    <li>
      Import the middleware to the router and use it to secure the GET route:
    ...
    <li>
      Send GET-request to the _/users_ route with the header `Authorization: user` and take a look at response - 401 status

      <img src={middleware_test1Img} alt="middleware_test1" />
    </li>
    <li>
      Send GET-request to the _/users_ route with the header `Authorization: admin` and take a look at response - we passed the check
...
<div className="bubble small subtle">
  ...
  [Zip file with the code from this block](/assets/zip/nodejs-1-en.zip)
