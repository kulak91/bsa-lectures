...
<div>
  <div class="author">
    <div class="avatar-wrapper">
      <object class="avatar-object" data={ulianaLobanova2021Avatar} role="img" aria-label="Uliana profile picture"></object>
    </div>
    <div class="profile">
      <h3 class="name">Uliana Lobanova</h3>
      <ul class="contacts">
        <li>
          <a href="https://www.linkedin.com/in/uliana-l-b34129105/" rel="author" class="linkedin">
...
And since the student writes in JS, the choice for the technology becomes obvious - Node.js. There is only one little thing left ― <span class="tooltip" data-tooltip='well, yeah, "little thing"...'><u>to learn this technology</u></span>.
<hr />
...
**Node.js** - is a **JavaScript** runtime, where we can run scripts. Everything will work <span class="tooltip" data-tooltip='"almost" because they only have V8 in common'><u>almost like in a browser</u></span>, so the transition from frontend to backend should be <span class="tooltip" data-tooltip='compared to learning a new language'><u>as comfortable as possible</u></span>.
...
Let's make our server smart and give it <span class="tooltip" data-tooltip="🕵️ 007 🔫"><u>logic, business logic</u></span>. In the world of Express applications, the layer that is responsible for business logic is called  **services**, and because it is not generated automatically, we will create it manually.
