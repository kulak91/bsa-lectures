---
orderId: 3
author: "Павел Немченко"
title: "PHP 7 features and ecosystem"
description: "Павел проводит экскурс в фундаментальные понятия и новинки <strong>PHP 7</strong>, объясняет в каких случаях используются наиболее распостраненные фреймворки, показывает как работать с <strong>Composer</strong> и рассказывает о типичном рабочем окружении PHP-программиста."
keywords: ["hola", "guapa"]
duration: "55 мин"
publishedAt: "2022-01-01T22:00:00"
...
import { pavelNemchenko2017Avatar } from "~/assets/images/avatars/intro-rounded";

import "./assets/stylesheets/styles.css";

<div><h1><strong>PHP 7 features and ecosystem</strong></h1></div>

<VideoWrapper duration="55 мин 8 сек">
  <iframe src="https://www.youtube.com/embed/n7qZgVI-I4U" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
</VideoWrapper>

<div>
  <div className="author">
    <div className="avatar-wrapper">
      <object className="avatar-object" data={pavelNemchenko2017Avatar} role="img" aria-label="My profile picture"></object>
    </div>
    <div className="profile">
      <h3 className="name">Павел Немченко</h3>
      <ul className="contacts">
        ...
        <li>
          <a href="https://github.com/nemoipaha" rel="author" className="github">
  ...
  <div className="bubble" style={{ margin: "-0.5em 1em 1em"}}>
    ...
    <ol className="compact inverted">
      <li>часть материала вам уже знакома и это гуд 😊;</li>
      <li>лекция обещает быть интересной и познавательной <em>(за употребление слов-паразитов, жаргона и нецензурной брани простите)</em>.</li>
    </ol>
...
<Level id="whats-new-in-php-7" number="2" name="What's new in PHP 7" difficulty="Hardcore." objectives="Learn what PHP 7 can offer us." />

![php7 rules](https://www.pvsm.ru/images/2016/12/20/uluchshenie-proizvoditelnosti-PHP-7.jpg)

The following are some of the new features in PHP 7 — it is faster ([PHP 5.6 vs 7.0](http://www.phpbenchmarks.com/en/comparator/php)), memory optimized, has new exception hierarchy, introduces new syntax sugar (`??, <=>`), nullables (`?string`), scalar type declarations, , `void` return type, iterable type, anonymous classes. Let's take a look at some of the features in detail:
...
<ul>
  ...
  <li className="details">
    ...
    <label className="summary" htmlFor="accordion-22">
      <span className="badge" data-badge="7.1">Nullables</span>
    </label>
    <div className="details-body">
  ...
  <li className="details">
    ...
    <label className="summary" htmlFor="accordion-23">
      <span className="badge" data-badge="7.1">Void type</span>
    </label>
    <div className="details-body">
  ...
  <li className="details">
    ...
    <label className="summary" htmlFor="accordion-24">
      <span className="badge" data-badge="7.1">Iterable type</span>
    </label>
    <div className="details-body">
    ...
    <div className="details-body">
      ...
      <ul>
        <li>
          ...
          <ul>
            <li>
              <code className="language-text">Exception implements Throwable</code>
              <ul>
                <li>
                  LogicException
                  <ul>
            ...
            <li>
              <code className="language-text">Error implements Throwable</code>
              <ul>
...
<h5>
  <img src="https://getcomposer.org/img/logo-composer-transparent2.png" alt="Composer logo" style={{ display: "inline-block",
    height: "1.2em",
    marginRight: "0.25em",
    verticalAlign: "top"
  }} />
